...
Plans:
- [x] 01-01-PLAN.md — Project scaffold, diff parser, TEA skeleton, panic hook, basic TUI
- [x] 01-02-PLAN.md — Syntax highlighting, keyboard navigation, collapse/expand, line numbers, statistics
- [x] 01-03-PLAN.md — Word-level inline diff highlighting and final verification
